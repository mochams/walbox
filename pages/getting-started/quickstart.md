...
See [PostgreSQL Setup](../production/setup.md) for production configuration, managed PostgreSQL details, and exact privilege requirements.
...
5. On restart, walbox resumes from this checkpoint
...
- **Production setup**: See [PostgreSQL Setup](../production/setup.md) for managed databases and [Deployment](../production/deployment.md) for running in production

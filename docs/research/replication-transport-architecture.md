...
- `PQflush`'s documented deadlock-avoidance contract, quoted verbatim: *"If it
  ...
  its.)"* This is a real, documented reason to race read-readiness and write-readiness
...
without walbox needing to know TLS is even involved. This is confirmed both by PostgreSQL's
